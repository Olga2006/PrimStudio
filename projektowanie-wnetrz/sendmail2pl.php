...
if (isset($_POST['ok'])){
	...
	header("Location: http://primstudio.net/projektowanie-wnetrz/ekskluzywne-meble-wloskiesent.shtml");
}
	else 
          {
          header("Location: http://primstudio.net/projektowanie-wnetrz/ekskluzywne-meble-wloskienosent.shtml");
