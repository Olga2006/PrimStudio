...
if (isset($_POST['ok'])){
	...
	header("Location: http://primstudio.net/interior-design/italian-luxury-furniture-france-rusent.shtml");
}
	else 
          {
          header("Location: http://primstudio.net/interior-design/italian-luxury-furniture-france-runosent.shtml");
