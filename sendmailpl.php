...
if (isset($_POST['ok'])){
	...
	header("Location: http://primstudio.net/projektowanie-wnetrz/cannes-architekt-wnetrzsent.shtml");
}
	else 
          {
          header("Location: http://primstudio.net/projektowanie-wnetrz/cannes-architekt-wnetrznosent.shtml");
