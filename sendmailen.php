...
if (isset($_POST['ok'])){
	...
	header("Location: http://primstudio.net/interior-design/cannes-interior-designer-rusent.shtml");
}
	else 
          {
          header("Location: http://primstudio.net/interior-design/cannes-interior-designer-runosent.shtml");
