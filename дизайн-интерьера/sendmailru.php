...
if (isset($_POST['ok'])){
	...
	header("Location: http://primstudio.net/дизайн-интерьера/канны-дизайнер-интерьераsent.shtml");
}
	else 
          {
          header("Location: http://primstudio.net/дизайн-интерьера/канны-дизайнер-интерьераnosent.shtml");
